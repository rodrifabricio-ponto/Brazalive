...
import { AdvancedAudioOptions, AudioEqualizationBandFrequency, AudioReverbType, CameraCapturerConfiguration, ChannelMediaOptions, CloudProxyType, DirectCdnStreamingMediaOptions, FeatureType, IDirectCdnStreamingEventHandler, IMetadataObserver, IRtcEngine, IRtcEngineEventHandler, IVideoDeviceManager, IVideoEffectObject, ImageTrackOptions, LeaveChannelOptions, Metadata, MetadataType, PriorityType, RtcEngineContext, SDKBuildInfo, ScreenCaptureConfiguration, ScreenCaptureSourceInfo, Size, StreamFallbackOptions, VideoDeviceInfo, VideoEffectAction } from '../IAgoraRtcEngine';
...
export declare class IVideoEffectObjectImpl implements IVideoEffectObject {
    addOrUpdateVideoEffect(nodeId: number, templateName: string): number;
    protected getApiTypeFromAddOrUpdateVideoEffect(nodeId: number, templateName: string): string;
    removeVideoEffect(nodeId: number): number;
    protected getApiTypeFromRemoveVideoEffect(nodeId: number): string;
    performVideoEffectAction(nodeId: number, actionId: VideoEffectAction): number;
    protected getApiTypeFromPerformVideoEffectAction(nodeId: number, actionId: VideoEffectAction): string;
    setVideoEffectStringParam(option: string, key: string, param: string): number;
    protected getApiTypeFromSetVideoEffectStringParam(option: string, key: string, param: string): string;
    setVideoEffectFloatParam(option: string, key: string, param: number): number;
    protected getApiTypeFromSetVideoEffectFloatParam(option: string, key: string, param: number): string;
    setVideoEffectIntParam(option: string, key: string, param: number): number;
    protected getApiTypeFromSetVideoEffectIntParam(option: string, key: string, param: number): string;
    setVideoEffectBoolParam(option: string, key: string, param: boolean): number;
    protected getApiTypeFromSetVideoEffectBoolParam(option: string, key: string, param: boolean): string;
    getVideoEffectFloatParam(option: string, key: string): number;
    protected getApiTypeFromGetVideoEffectFloatParam(option: string, key: string): string;
    getVideoEffectIntParam(option: string, key: string): number;
    protected getApiTypeFromGetVideoEffectIntParam(option: string, key: string): string;
    getVideoEffectBoolParam(option: string, key: string): boolean;
    protected getApiTypeFromGetVideoEffectBoolParam(option: string, key: string): string;
}
...
export declare class IRtcEngineImpl implements IRtcEngine {
    ...
    createVideoEffectObject(bundlePath: string, type?: MediaSourceType): IVideoEffectObject;
    protected getApiTypeFromCreateVideoEffectObject(bundlePath: string, type?: MediaSourceType): string;
    destroyVideoEffectObject(videoEffectObject: IVideoEffectObject): number;
    protected getApiTypeFromDestroyVideoEffectObject(videoEffectObject: IVideoEffectObject): string;
