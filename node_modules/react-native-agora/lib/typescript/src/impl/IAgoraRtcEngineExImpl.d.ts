...
import { ChannelMediaOptions, ImageTrackOptions, LeaveChannelOptions, StreamFallbackOptions } from '../IAgoraRtcEngine';
...
export declare class IRtcEngineExImpl extends IRtcEngineImpl implements IRtcEngineEx {
    ...
    enableVideoImageSourceEx(enable: boolean, options: ImageTrackOptions, connection: RtcConnection): number;
    protected getApiTypeFromEnableVideoImageSourceEx(enable: boolean, options: ImageTrackOptions, connection: RtcConnection): string;
    preloadEffectEx(connection: RtcConnection, soundId: number, filePath: string, startPos?: number): number;
    protected getApiTypeFromPreloadEffectEx(connection: RtcConnection, soundId: number, filePath: string, startPos?: number): string;
    ...
    protected getApiTypeFromPlayEffectEx(connection: RtcConnection, soundId: number, filePath: string, loopCount: number, pitch: number, pan: number, gain: number, publish?: boolean, startPos?: number): string;
