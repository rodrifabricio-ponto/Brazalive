 ...
 */
export declare enum VideoEffectNodeId {
    /**
 ...
 * Since Available since v4.6.2.
 */
export declare enum VideoEffectAction {
    /**
 ...
 * Since Available since v4.6.2.
 */
export declare abstract class IVideoEffectObject {
    /**
     ...
     *  < 0: Failure.
     */
    abstract performVideoEffectAction(nodeId: number, actionId: VideoEffectAction): number;
    /**
     * @ignore
     */
    abstract setVideoEffectStringParam(option: string, key: string, param: string): number;
    /**
     ...
     *  < 0: Failure.
     */
    abstract setVideoEffectFloatParam(option: string, key: string, param: number): number;
    /**
     ...
     *  < 0: Failure.
     */
    abstract setVideoEffectIntParam(option: string, key: string, param: number): number;
    /**
     ...
     *  < 0: Failure.
     */
    abstract setVideoEffectBoolParam(option: string, key: string, param: boolean): number;
    /**
...
export declare abstract class IRtcEngine {
     ...
     */
    abstract createVideoEffectObject(bundlePath: string, type?: MediaSourceType): IVideoEffectObject;
    /**
     ...
     *  < 0: Failure.
     */
    abstract destroyVideoEffectObject(videoEffectObject: IVideoEffectObject): number;
    /**
