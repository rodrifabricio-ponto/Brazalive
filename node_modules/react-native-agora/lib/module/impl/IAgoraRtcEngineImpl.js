...
// @ts-ignore
export class IVideoEffectObjectImpl {
...
export class IRtcEngineImpl {
  ...
  startPreview(sourceType = VideoSourceType.VideoSourceCameraPrimary) {
  ...
  getApiTypeFromStartPreview(sourceType = VideoSourceType.VideoSourceCameraPrimary) {
    return 'RtcEngine_startPreview_4fd718e';
  }
  stopPreview(sourceType = VideoSourceType.VideoSourceCameraPrimary) {
  ...
  getApiTypeFromStopPreview(sourceType = VideoSourceType.VideoSourceCameraPrimary) {
  ...
  setBeautyEffectOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromSetBeautyEffectOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_setBeautyEffectOptions_e7635d1';
  }
  setFaceShapeBeautyOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromSetFaceShapeBeautyOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_setFaceShapeBeautyOptions_a862ce7';
  }
  setFaceShapeAreaOptions(options, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromSetFaceShapeAreaOptions(options, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_setFaceShapeAreaOptions_2e242a3';
  }
  getFaceShapeBeautyOptions(type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromGetFaceShapeBeautyOptions(type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_getFaceShapeBeautyOptions_8382895';
  }
  getFaceShapeAreaOptions(shapeArea, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromGetFaceShapeAreaOptions(shapeArea, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_getFaceShapeAreaOptions_0783e2c';
  }
  setFilterEffectOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromSetFilterEffectOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_setFilterEffectOptions_53b4be3';
  }
  createVideoEffectObject(bundlePath, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromCreateVideoEffectObject(bundlePath, type = MediaSourceType.PrimaryCameraSource) {
  ...
  setLowlightEnhanceOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromSetLowlightEnhanceOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_setLowlightEnhanceOptions_4f9f013';
  }
  setVideoDenoiserOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromSetVideoDenoiserOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_setVideoDenoiserOptions_4e9fccc';
  }
  setColorEnhanceOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromSetColorEnhanceOptions(enabled, options, type = MediaSourceType.PrimaryCameraSource) {
    return 'RtcEngine_setColorEnhanceOptions_ecae2b3';
  }
  enableVirtualBackground(enabled, backgroundSource, segproperty, type = MediaSourceType.PrimaryCameraSource) {
  ...
  getApiTypeFromEnableVirtualBackground(enabled, backgroundSource, segproperty, type = MediaSourceType.PrimaryCameraSource) {
  ...
  setAudioProfile(profile, scenario = AudioScenarioType.AudioScenarioDefault) {
  ...
  getApiTypeFromSetAudioProfile(profile, scenario = AudioScenarioType.AudioScenarioDefault) {
  ...
  setLocalRenderMode(renderMode, mirrorMode = VideoMirrorModeType.VideoMirrorModeAuto) {
  ...
  getApiTypeFromSetLocalRenderMode(renderMode, mirrorMode = VideoMirrorModeType.VideoMirrorModeAuto) {
  ...
  enableExtension(provider, extension, enable = true, type = MediaSourceType.UnknownMediaSource) {
  ...
  getApiTypeFromEnableExtension(provider, extension, enable = true, type = MediaSourceType.UnknownMediaSource) {
    return 'RtcEngine_enableExtension_0b60a2c';
  }
  setExtensionProperty(provider, extension, key, value, type = MediaSourceType.UnknownMediaSource) {
  ...
  getApiTypeFromSetExtensionProperty(provider, extension, key, value, type = MediaSourceType.UnknownMediaSource) {
    return 'RtcEngine_setExtensionProperty_520ac55';
  }
  getExtensionProperty(provider, extension, key, bufLen, type = MediaSourceType.UnknownMediaSource) {
  ...
  getApiTypeFromGetExtensionProperty(provider, extension, key, bufLen, type = MediaSourceType.UnknownMediaSource) {
  ...
  registerExtension(provider, extension, type = MediaSourceType.UnknownMediaSource) {
  ...
  getApiTypeFromRegisterExtension(provider, extension, type = MediaSourceType.UnknownMediaSource) {
