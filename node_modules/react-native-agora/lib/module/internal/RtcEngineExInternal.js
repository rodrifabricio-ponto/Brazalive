...
import { EVENT_TYPE, addScopedEventListener, removeAllEventListeners, removeAllScopedEventListeners, removeScopedEventListener } from './event';
...
export class RtcEngineExInternal extends IRtcEngineExImpl {
  ...
  addListener(eventType, listener) {
    ...
    addScopedEventListener(this, eventType, callback);
  }
  removeListener(eventType, listener) {
    removeScopedEventListener(this, eventType,
    // @ts-ignore
