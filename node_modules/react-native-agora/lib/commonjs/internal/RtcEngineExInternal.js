...
var _VideoEffectObjectInternal = require("./VideoEffectObjectInternal");
...
class RtcEngineExInternal extends _IAgoraRtcEngineExImpl.IRtcEngineExImpl {
  ...
  release(sync = false) {
    ...
    (0, _event.removeAllEventListeners)();
    super.release(sync);
  }
  ...
  addListener(eventType, listener) {
    ...
    (0, _event.addScopedEventListener)(this, eventType, callback);
  }
  removeListener(eventType, listener) {
    (0, _event.removeScopedEventListener)(this, eventType,
    // @ts-ignore
    (listener === null || listener === void 0 ? void 0 : listener.agoraCallback) ?? listener);
  }
  removeAllListeners(eventType) {
    (0, _event.removeAllScopedEventListeners)(this, eventType);
  }
  getVersion() {
  ...
  createVideoEffectObject(bundlePath, type) {
    ...
    return new _VideoEffectObjectInternal.VideoEffectObjectInternal(videoEffectObjectId);
  }
