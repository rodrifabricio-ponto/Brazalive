...
exports.EVENT_PROCESSORS = void 0;
...
const EVENT_PROCESSORS = exports.EVENT_PROCESSORS = {
  IAudioFrameObserver: {
    ...
    type: () => _event2.EVENT_TYPE.IMediaEngine,
  ...
  IAudioSpectrumObserver: {
    ...
    type: data => data.playerId === 0 ? _event2.EVENT_TYPE.IRtcEngine : _event2.EVENT_TYPE.IMediaPlayer,
  ...
  IAudioEncodedFrameObserver: {
    ...
    type: () => _event2.EVENT_TYPE.IRtcEngine,
  ...
  IMediaPlayerSourceObserver: {
    ...
    type: () => _event2.EVENT_TYPE.IMediaPlayer,
  ...
  IMediaRecorderObserver: {
    ...
    type: () => _event2.EVENT_TYPE.IMediaRecorder,
  ...
  IMusicContentCenterEventHandler: {
    ...
    type: () => _event2.EVENT_TYPE.IMusicContentCenter,
  ...
  IH265TranscoderObserver: {
    ...
    type: () => _event2.EVENT_TYPE.IAgoraH265Transcoder,
  ...
  AgoraPipStateChangedObserver: {
    suffix: 'AgoraPip_',
    type: () => _event2.EVENT_TYPE.IAgoraPip,
...
function handleEvent({
  ...
  (0, _event2.emitEvent)(_event, processor, _data);
}
