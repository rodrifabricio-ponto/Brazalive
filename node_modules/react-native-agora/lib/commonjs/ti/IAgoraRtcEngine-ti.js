...
const IRtcEngineEventHandler = exports.IRtcEngineEventHandler = t.iface([], {
...
const IMetadataObserver = exports.IMetadataObserver = t.iface([], {
  "onMetadataReceived": t.opt(t.func("void", t.param("metadata", "Metadata")))
});
const IDirectCdnStreamingEventHandler = exports.IDirectCdnStreamingEventHandler = t.iface([], {
